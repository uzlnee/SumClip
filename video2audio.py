...
def download_video_from_url(url: str):
    ...
    ydl_opts = {
        'format': 'best',
        'outtmpl': 'videos/video_1/%(title)s.%(ext)s',  # Save in a specific folder
    }
    os.makedirs('videos/video_1', exist_ok=True)  # Create directory for the video
...
def process_youtube_video(url: str):
    ...
    audio_file = f"{video_folder}/video_1_audio.mp3"
